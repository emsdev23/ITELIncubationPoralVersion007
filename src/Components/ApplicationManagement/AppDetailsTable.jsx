...
import "./AppDetailsTable.css"; // We'll update this file
...
export default function AppDetailsTable() {
  ...
  const exportToCSV = () => {
    ...
    const exportData = filteredApps.map((item) => ({
      ...
      "Created By": item.guiappscreatedby || "",
      "Modified By": item.guiappsmodifiedby || "",
    }));
  ...
  const columns = [
    ...
    {
      field: "guiappscreatedby",
      headerName: "Created By",
      width: 120,
      sortable: true,
    },
    {
      field: "guiappsmodifiedby",
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Box sx={{ display: "flex", gap: 2, mb: 2, alignItems: "center" }}>
        <TextField
          label="Search by name, path or group..."
          variant="outlined"
          size="small"
          value={searchQuery}
