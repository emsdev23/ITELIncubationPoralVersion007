  ...
  const handleSendResetLink = async () => {
    ...
    try {
      ...
      const response = await api.post(
        ...
        {
          email,
          frontendUrl, // Include this so the backend knows where to redirect
        },
        {
          headers: {
            userid: userid || "1",
      ...
      if (response.data.statusCode === 200) {
        // Show SweetAlert with more specific message
        Swal.fire({
          icon: "success",
          title: "Reset Link Sent",
          text: "Please check your email inbox for the password reset link. If you don't see it, check your spam folder.",
